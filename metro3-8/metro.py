...
async def on_ready():
    ...
    bot.stats = Document(bot.db, "stats")
    ...
    bot.giveaway = Document(bot.db, "giveaway")
    ...
    bot.profile = Document(bot.db, "profile")
    ...
    data = {"_id" : bot.user.id, "uptime" : ready}
    await bot.stats.update(data)
