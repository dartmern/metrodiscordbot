...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.playing, name=f"Dank Memer"))
...
async def on_guild_join(guild):
    ...
    await bot.welcomeOn.upsert({"_id": guild.id, "welcomeOn":"Off"})
